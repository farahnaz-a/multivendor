...
@section('content')
    ...
    <div class="courses-grid">
      {{-- <div id="w-node-_3c150f7d-4a03-3fb0-728d-7e6e17194390-b38e5e8e" class="product-image-wrapper"><img src="../images/Crush-Course.jpg" loading="lazy" alt="" class="product-image"></div> --}}
