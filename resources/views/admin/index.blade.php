...
<!-- Mirrored from themesbrand.com/minible/layouts/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Sep 2020 11:40:13 GMT -->
<head>
        ...
        <link href="{{ asset('dashboard_assets/assets/css/icon.css') }}" rel="stylesheet" type="text/css" />
        <!-- App Css-->
    ...
    <!-- <body data-layout="horizontal" data-topbar="colored"> -->
        ...
        <script src="{{ asset('dashboard_assets/assets/libs/waypoints/lib/jquery.waypoints.min.js/') }}"></script>
        <script src="{{ asset('dashboard_assets/assets/libs/jquery.counterup/jquery.counterup.min.js/') }}"></script>

        <!-- apexcharts -->
        <script src="{{ asset('dashboard_assets/assets/libs/apexcharts/apexcharts.min.js/') }}"></script>

        <script src="{{ asset('dashboard_assets/assets/js/pages/dashboard.init.js/') }}"></script>
...
<!-- Mirrored from themesbrand.com/minible/layouts/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Sep 2020 11:40:42 GMT -->
</html>