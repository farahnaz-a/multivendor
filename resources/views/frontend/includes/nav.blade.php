    ...
    <div class="navbar">
      <div class="navwrapper">
        <div data-w-id="869f715c-9209-0b63-210e-1896e262a1fa" class="navlinkwrapper">
          ...
          <a data-w-id="869f715c-9209-0b63-210e-1896e262a205" href="{{ url('/products-courses') }}" class="nav-link _2 w-inline-block">
            <div class="nav-wrap _2">
              <div class="round-wrap"><img src="{{ asset('frontend_assets/images/brain.svg') }}" loading="lazy" alt="" class="round-image"></div>
              <div class="nav-block">
                <div class="navlink">Products</div>
                <p class="paragraph-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
              </div><img src="{{ asset('frontend_assets/images/settings-1.svg') }}" loading="lazy" alt="" class="right-side-logo">
            </div>
          </a>
     <a data-w-id="869f715c-9209-0b63-210e-1896e262a20f" href="{{ url('/products-courses') }}" class="nav-link _3 w-inline-block">
          ...
          <a data-w-id="869f715c-9209-0b63-210e-1896e262a219" href="{{ route('frontend.about') }}" class="nav-link _4 w-inline-block">
