...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ url('/') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Email">Frontend</span></a></li>
                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Apps &amp; Pages</span><i data-feather="more-horizontal"></i></li>
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="{{ route('dashboard') }}">
                        <i data-feather='user'></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Admin Pannel</span>
                     </a>
                </li>
                <li class="@yield('categories') nav-item">
                ...
                <li class="@yield('subcategories') nav-item">
                    <a class="d-flex align-items-center" href="{{ route('subCategories.index') }}">
                        <i data-feather="framer"></i>
                        <span class="menu-title text-truncate" data-i18n="Chat">Subcategories</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        <li class="@yield('productsIndex')">
                            <a class="d-flex align-items-center" href="{{ route('products.index') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                        </li>
                        <li class="@yield('productsCreate')">
                            <a class="d-flex align-items-center" href="{{ route('products.create') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">Add</span></a>
                        </li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT
                &copy; 2021<a class="ml-25" href="https://dgtaltech.com" target="_blank">Digital Tech</a><span class="d-none d-sm-inline-block">,
