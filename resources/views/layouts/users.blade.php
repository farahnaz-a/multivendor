      ...
      <div class="dashboard-sidebar">
        ...
        <div class="sidebar-menu">
          <div class="sidebar-menu-section">
            ...
            <a href="{{ route('cart.index') }}" class="sidebar-link w-inline-block"><img src="{{ asset('frontend_assets/images/online-course.svg') }}" loading="lazy" alt="" class="sidebar-icon">
              <div class="sidebar-link-text">My Cart</div>
            </a>
